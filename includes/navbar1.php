...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
  ...
  <div class="sidebar-brand-text mx-3">Hotel <sup>WEB IT</sup></div>
</a>
...
<!-- Nav Item - Maintain Menu -->
<li class="nav-item">
  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#maintain" aria-expanded="true" aria-controls="maintain">
    <i class="fa fa-cogs"></i>
    <span>Maintainess </span>
  </a>
  <div id="maintain" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <h6 class="collapse-header">Custom Components:</h6>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <form action="logout.php" method="POST"> 
            ...
            <button type="submit" name="logout_btn" class="btn btn-default btn-flat"><a href="index.php">Logout</a></button>
          </form>
        </div>
      </div>
    </div>
